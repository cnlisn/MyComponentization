...
import com.lisn.annotation.RouterConst;
import com.lisn.annotation.facade.enums.RouteType;
...
public class RouterProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        if (!annotations.isEmpty()) {
            ...
            Set<? extends Element> routeCommElemtents = roundEnv.getElementsAnnotatedWith(SRoute.class);
...
//        }
    private void generatedClassComm(String packageName, Set<? extends Element> routeElements) {
        ...
        TypeMirror typeFragmentX = elementUtils.getTypeElement(RouteType.FRAGMENT_X.getClassName()).asType();//
        ...
        for (Element element : routeElements) {
            SRoute routeComm = element.getAnnotation(SRoute.class);//拿到检测到的注解，因为拿到它之后，就能取注解内的参数值
            ...
            if (typeUtils.isSubtype(tm, typeActivity)) {//参数1，是不是参数2的子类
                ...
                routeType = RouteType.ACTIVITY;
                    ...
                    || typeUtils.isSubtype(tm, typeFragmentX)) {//fragment有多个版本，这里要兼容
                //如果这次是Fragment
    ...
    public Set<String> getSupportedAnnotationTypes() {
        ...
        types.add(SRoute.class.getCanonicalName());
        return types;
    }
