...
import com.lisn.annotation.IRouterS;
import com.lisn.annotation.RouterConst;
import com.lisn.annotation.facade.model.RouteMeta;
import com.lisn.api.ClassUtils;
import com.lisn.api.Postcard;
    ...
    private static void registerComm() {
        try {
            ...
            for (String className : classNames) {
                Log.e("---", "registerComm: " + className);
                Class<?> clz = Class.forName(className);
                if (IRouterS.class.isAssignableFrom(clz)) {
                    IRouterS iRouterComm = (IRouterS) clz.getConstructor().newInstance();
