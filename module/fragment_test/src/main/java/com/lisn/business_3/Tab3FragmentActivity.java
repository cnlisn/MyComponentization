...
public class Tab3FragmentActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Tab3Fragment tab3Fragment = Tab3Fragment.newInstance(null);
        showFragment(tab3Fragment);
    }

    @Override
    public void onClick(View v) {
        SRouter.getInstance().build("").navigation();
    }
